...
"""
 ...
 Java SimpleDate Format for rundate argument: YYYY-MM-DD, e.g. 2019-12-31
 e.g. -c newslookout.conf -d ${current_date:yyyy-MM-dd}
    ...
    def readConfig(self):
        ...
        try:
            ...
            try:
                ...
                print("Exception caught creating data directory", self.configData['data_dir'], ": ", theError)
