...
def testPluginSubClass():
    ...
    from plugins.mod_en_in_livemint import mod_en_in_livemint
    import data_structs
    import session_hist
    ...
    assert type(pluginClassInst.networkHelper) == network.NetworkFetcher, "mod_en_in_livemint network fetcher not init!"
...
def test_fetchDataFromURL():
    ...
    assert resultVal.textSize == 2936, 'fetchDataFromURL() not parsing text body correctly.'
