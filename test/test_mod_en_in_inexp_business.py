...
def testPluginSubClass():
    ...
    assert type(pluginClassInst.networkHelper) == network.NetworkFetcher,\
...
def test_fetchDataFromURL():
    ...
    assert resultVal.savedDataFileName == './data\\2021-02-01\\mod_en_in_inexp_business_2258178', \
