...
def test_plugin_subclass():
    ...
    from newslookout .plugins.mod_keywordflags import mod_keywordflags
    from newslookout import data_structs
    from newslookout import session_hist
    # instantiate the plugin object:
    pluginClassInst = mod_keywordflags()
    print(f'Instantiated plugin name: {pluginClassInst.pluginName}')
    assert type(pluginClassInst).__name__ == "mod_keywordflags", \
        "mod_keywordflags Plugin was not initialising correctly"
