...
"""
NewsLookout – web scraping application for news articles.

Public API::

    from newslookout import NewsLookoutApp
    app = NewsLookoutApp('path/to/config.conf')
    app.run(run_date='2026-03-22')
"""


from newslookout.scraper_app import NewsLookoutApp, main  # noqa: F401

__all__ = ['NewsLookoutApp', 'main']
