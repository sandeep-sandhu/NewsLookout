...
from newslookout.scraper_utils import deDupeList, filterRepeatedchars
...
class mod_en_in_moneycontrol(BasePlugin):
    ...
    """
    # TODO: encoding error : input conversion failed due to input error, bytes 0x81 0xE0 0xAA 0x9C
    # TODO encoding error : input conversion failed due to input error, bytes 0x81 0xE0 0xAA 0x9C
    # beautifulsoup library error
